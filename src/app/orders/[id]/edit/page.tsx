...
function lineToForm(line: {
  ...
  pricingQuantity: number | null; unitPrice: unknown; amount: unknown; note: string | null; imagePath: string | null; imageWidth?: number | null; imageHeight?: number | null; modelCheck: string | null; priceCheck: string | null;
}) {
  return {
    ...
    unitPrice: textNumber(line.unitPrice), amount: textNumber(line.amount), note: line.note ?? "", imagePath: line.imagePath ?? "",
    imageWidth: textNumber(line.imageWidth), imageHeight: textNumber(line.imageHeight),
    modelCheck: line.modelCheck ?? "", priceCheck: line.priceCheck ?? "",
  };
}
