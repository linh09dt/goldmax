...
# ================= 3. TỔ SƠN =================
doc.add_page_break()
head("3. TỔ SƠN  (nút thắt theo bảng công đoạn — 2 đơn vị thời gian)")
qs([
...
# ================= 6. TỔ KHO =================
head("6. TỔ KHO  (Vệ sinh · Đóng gói · Kho · Giao hàng · Lắp đặt)")
sub("6.1. Công đoạn VỆ SINH + ĐÓNG GÓI")
qs([
...
# ================= 7. XUYÊN SUỐT =================
doc.add_page_break()
head("7. CÁC VẤN ĐỀ XUYÊN SUỐT KHI LÊN KẾ HOẠCH  (dành cho người lên kế hoạch / quản đốc)")
...
sub("7.4. Cập nhật tiến độ &amp; báo cáo")
qs([
...
# ================= 8-11. BẢNG =================
doc.add_page_break()
head("8. BẢNG ĐIỀN THỜI LƯỢNG CÔNG ĐOẠN (đơn vị thời gian: ..................... )")
...
head("9. DỮ LIỆU APP CẦN THÊM (đánh dấu: Cần / Không cần)")
...
head("10. KIỂM TRA CHÉO — thông tin app đang có, xưởng có dùng không?")
...
head("11. MẶC ĐỊNH nếu chưa trả lời được (app vẫn chạy, sửa lại sau)")
...
run(p, "GOLDMAX · Bộ câu hỏi đầy đủ theo tổ & công đoạn cho module Lên kế hoạch sản xuất · V123. "
       "Bản ngắn để trao đổi nhanh: V117 · Bản theo quyết định thiết kế: V122 · Tham chiếu: V116, V119, V120, V121.", size=7.5, italic=True, color=XAM)

out = "/home/user/.workspace/artifacts/bo-cau-hoi-day-du-theo-to-v123.docx"
doc.save(out)
print("đã tạo:", out)
